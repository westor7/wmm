...
ON *:INPUT:#: {
  ...
  if (%action) {
    ...
    if (!$wmm_isurl($2)) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(44) - $lang(45) - ( $+ $lang(39) $wmm_bold($1 $wmm_under($wmm_page)) $+ ) | return }
    .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(46) $wmm_under($wmm_tinycom($2)) $+ .
  }
...
ON $*:TEXT:$(/^(\Q $+ $replacecs($evalnext($+(%,$mod,_prefix_nick)),\E,\E\\E\Q) $+ \E|\Q $+ $replacecs($evalnext($+(%,$mod,_prefix_chan)),\E,\E\\E\Q) $+ \E).*/Si):#: {
  ...
  if (%action) {
    ...
    if (!$wmm_isurl($2)) { %action ( $+ $wmm_bold($nick) $+ ): $lang(44) - $lang(45) - ( $+ $lang(39) $wmm_bold($1 $wmm_under($wmm_page)) $+ ) | return }
    %action ( $+ $wmm_bold($nick) $+ ): $lang(46) $wmm_under($wmm_tinycom($2)) $+ .
  }
...
alias wtu_ver { return $right($gettok($read($script,n,6),3,32),3) }
alias wtu_crdate { return $remove($gettok($read($script,n,6),5,32),$chr(40),$chr(41)) }

alias -l mod { return wtu }
alias -l command { return tiny }
...
#wtu_menu_status end
#wtu_menu_channel off
menu channel { 
  -
  $iif($isalias(wmm_isadi) && $wmm_isadi && $file($scriptdir $+ $mod $+ _main.ico),$menuicon($scriptdir $+ $mod $+ _main.ico)) $iif($dialog( [ $+ [ $mod ] $+ ] _sets),$style(1)) $iif($isalias(wmm_qd),$wmm_qd($addon v $+ $ [ $+ [ $mod ] $+ ] _ver - $iif($lang(4),$v1,Settings) $+ ),* $addon v $+ $ [ $+ [ $mod ] $+ ] _ver - Settings *): $+ $mod $+ _sets
  -
}
#wtu_menu_channel end
#wtu_menu_nicklist off
menu nicklist { 
  -
  $iif($isalias(wmm_isadi) && $wmm_isadi && $file($scriptdir $+ $mod $+ _main.ico),$menuicon($scriptdir $+ $mod $+ _main.ico)) $iif($dialog( [ $+ [ $mod ] $+ ] _sets),$style(1)) $iif($isalias(wmm_qd),$wmm_qd($addon v $+ $ [ $+ [ $mod ] $+ ] _ver - $iif($lang(4),$v1,Settings) $+ ),* $addon v $+ $ [ $+ [ $mod ] $+ ] _ver - Settings *): $+ $mod $+ _sets
  -
}
#wtu_menu_nicklist end
#wtu_menu_query off
menu query { 
  -
  $iif($isalias(wmm_isadi) && $wmm_isadi && $file($scriptdir $+ $mod $+ _main.ico),$menuicon($scriptdir $+ $mod $+ _main.ico)) $iif($dialog( [ $+ [ $mod ] $+ ] _sets),$style(1)) $iif($isalias(wmm_qd),$wmm_qd($addon v $+ $ [ $+ [ $mod ] $+ ] _ver - $iif($lang(4),$v1,Settings) $+ ),* $addon v $+ $ [ $+ [ $mod ] $+ ] _ver - Settings *): $+ $mod $+ _sets
