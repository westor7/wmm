...
alias -l command { return soundcloud }
...
alias wss_soundcloud_search {
  ...
  jsonopen -ud %v https://api.soundcloud.com/tracks/?client_id= $+ $wmm_apikey($addon) $+ &q= $+ $wmm_urlencode($4-) $+ &format=json&limit= $+ % [ $+ [ $mod ] $+ ] _max_results
  ...
  while (%x < % [ $+ [ $mod ] $+ ] _max_results) {
    ...
    if (% [ $+ [ $mod ] $+ ] _show_empty) { 
      var %msg = 0,7 $+ $gettok($addon,1,45) $+ -0,14 $+ $gettok($addon,2,45) $+ : $wmm_bel $iif(%title !== $null,$wmm_bold($lang(49)) $+ :6 %title $+ ) $iif(%desc !== $null,$wmm_sep $wmm_bold($lang(61)) $+ :14 %desc $+ ) $iif(%duration !== $null,$wmm_sep $wmm_bold($lang(50)) $+ :10 %duration $+ ) $iif(%views !== $null,$wmm_sep $wmm_bold($iif(%views == 1,$lang(43),$lang(51))) $+ :13 $gettok($bytes(%views,bd),1,46) $+ ) $iif(%likes !== $null,$wmm_sep $wmm_bold($iif(%likes == 1,$lang(62),$lang(66))) $+ :3 $gettok($bytes(%likes,bd),1,46) $+ ) $iif(%size !== $null,$wmm_sep $wmm_bold($lang(63)) $+ :2 $bytes(%size).suf $+ ) $iif(%genre !== $null,$wmm_sep $wmm_bold($lang(64)) $+ :12 %genre $+ ) $iif(%format !== $null,$wmm_sep $wmm_bold($lang(65)) $+ :5 %format $+ ) $iif(%favorites !== $null,$wmm_sep $wmm_bold($iif(%favorites == 1,$lang(59),$lang(54))) $+ :12 $gettok($bytes(%favorites,bd),1,46) $+ ) $iif(%reposts !== $null,$wmm_sep $wmm_bold($iif(%reposts == 1,$lang(45),$lang(53))) $+ :11 $gettok($bytes(%reposts,bd),1,46) $+ ) $iif(%downloads !== $null,$wmm_sep $wmm_bold($iif(%downloads == 1,$lang(44),$lang(52))) $+ :4 $gettok($bytes(%downloads,bd),1,46) $+ ) $iif(%comments !== $null,$wmm_sep $wmm_bold($iif(%comments == 1,$lang(60),$lang(55))) $+ :8 $gettok($bytes(%comments,bd),1,46) $+ ) $iif(%crdate !== $null,$wmm_sep $wmm_bold($lang(56)) $+ :7 %crdate $+ ) $iif(%uploader !== $null,$wmm_sep $wmm_bold($lang(57)) $+ :2 %uploader $+ ) $iif(%url !== $null,$wmm_sep $wmm_bold($lang(58)) $+ : 12 $+ %url $+ )
      %output $iif(% [ $+ [ $mod ] $+ ] _strip,$strip(%msg),%msg)
    }
    elseif (!% [ $+ [ $mod ] $+ ] _show_empty) { 
      var %msg = 0,7 $+ $gettok($addon,1,45) $+ -0,14 $+ $gettok($addon,2,45) $+ : $wmm_bel $iif(%title,$wmm_bold($lang(49)) $+ :6 %title $+ ) $iif(%desc,$wmm_sep $wmm_bold($lang(61)) $+ :14 %desc $+ ) $iif(%duration,$wmm_sep $wmm_bold($lang(50)) $+ :10 %duration $+ ) $iif(%views,$wmm_sep $wmm_bold($iif(%views == 1,$lang(43),$lang(51))) $+ :13 $gettok($bytes(%views,bd),1,46) $+ ) $iif(%likes,$wmm_sep $wmm_bold($iif(%likes == 1,$lang(66),$lang(62))) $+ :3 $gettok($bytes(%likes,bd),1,46) $+ ) $iif(%size,$wmm_sep $wmm_bold($lang(63)) $+ :2 $bytes(%size).suf $+ ) $iif(%genre,$wmm_sep $wmm_bold($lang(64)) $+ :12 %genre $+ ) $iif(%format,$wmm_sep $wmm_bold($lang(65)) $+ :5 %format $+ ) $iif(%favorites,$wmm_sep $wmm_bold($iif(%favorites == 1,$lang(59),$lang(54))) $+ :12 $gettok($bytes(%favorites,bd),1,46) $+ ) $iif(%reposts,$wmm_sep $wmm_bold($iif(%reposts == 1,$lang(45),$lang(53))) $+ :11 $gettok($bytes(%reposts,bd),1,46) $+ ) $iif(%downloads,$wmm_sep $wmm_bold($iif(%downloads == 1,$lang(44),$lang(52))) $+ :4 $gettok($bytes(%downloads,bd),1,46) $+ ) $iif(%comments,$wmm_sep $wmm_bold($iif(%comments == 1,$lang(60),$lang(55))) $+ :8 $gettok($bytes(%comments,bd),1,46) $+ ) $iif(%crdate,$wmm_sep $wmm_bold($lang(56)) $+ :7 %crdate $+ ) $iif(%uploader,$wmm_sep $wmm_bold($lang(57)) $+ :2 %uploader $+ ) $iif(%url,$wmm_sep $wmm_bold($lang(58)) $+ : 12 $+ %url $+ )
      %output $iif(% [ $+ [ $mod ] $+ ] _strip,$strip(%msg),%msg)
    }
