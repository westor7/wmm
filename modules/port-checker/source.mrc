...
dialog -l wpc_sets {
  ...
  check "Display the module output messages", 620, 160 19 155 10, tab 13
  menu "Menu", 22
  item "Help", 23, 22
  item break, 501
  item "About", 24, 22
...
ON *:INPUT:#: {
  ...
  if (%action) {
    ...
    if (!$2) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(37) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(52) $+ : $+ $lang(51)) $+ >) $lang(53) $wmm_bold($1 < $+ $wmm_under($lang(52) $lang(51)) $+ >) - ( $+ $lang(39) $+ 1: $wmm_bold($1 $wmm_under($serverip) $+ : $+ $wmm_under($abs($port))) $+ ) - ( $+ $lang(39) $+ 2: $wmm_bold($1 $wmm_under($serverip) $wmm_under($abs($port))) $+ ) | return }
    if ($count($2,$chr(46)) !== 3) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) !isin $2) && (!$3) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(37) - $lang(48) | return }
    if ($chr(58) !isin $2) && ($3 !isnum) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(44) - $lang(49) | return }
    if ($chr(58) isin $2) && ($remove($2,$chr(46),$chr(58)) !isnum) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) !isin $2) && ($remove($2,$chr(46)) !isnum) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) isin $2) && ($gettok($2,2,58) !isnum) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(44) - $lang(49) | return }
    if ($chr(58) isin $2) && (!$longip($gettok($2,1,58))) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) !isin $2) && (!$longip($2)) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) isin $2) && ($gettok($2,1,58) == 127.0.0.1) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) !isin $2) && ($2 == 127.0.0.1) { .timer -h 1 0 %action ( $+ $wmm_bold($me) $+ ): $lang(44) - $lang(45) | return }
    var %s = $mod $+ _portchecker_ $+ $wmm_random
    sockopen %s $replace($2-,$chr(58),$chr(32))
    sockmark %s $nick $chan %action $replace($2-,$chr(58),$chr(32))
  }
...
ON $*:TEXT:$(/^(\Q $+ $replacecs($evalnext($+(%,$mod,_prefix_nick)),\E,\E\\E\Q) $+ \E|\Q $+ $replacecs($evalnext($+(%,$mod,_prefix_chan)),\E,\E\\E\Q) $+ \E).*/Si):#: {
  ...
  if (%action) {
    hadd -mu6 $upper($mod) $+ _FLOOD %cn 1
    if (!$2) { %action ( $+ $wmm_bold($nick) $+ ): $lang(37) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(52) $+ : $+ $lang(51)) $+ >) $lang(53) $wmm_bold($1 < $+ $wmm_under($lang(52) $lang(51)) $+ >) - ( $+ $lang(39) $+ 1: $wmm_bold($1 $wmm_under($serverip) $+ : $+ $wmm_under($abs($port))) $+ ) - ( $+ $lang(39) $+ 2: $wmm_bold($1 $wmm_under($serverip) $wmm_under($abs($port))) $+ ) | return }
    if ($count($2,$chr(46)) !== 3) { %action ( $+ $wmm_bold($nick) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) !isin $2) && (!$3) { %action ( $+ $wmm_bold($nick) $+ ): $lang(37) - $lang(48) | return }
    if ($chr(58) !isin $2) && ($3 !isnum) { %action ( $+ $wmm_bold($nick) $+ ): $lang(44) - $lang(49) | return }
    if ($chr(58) isin $2) && ($remove($2,$chr(46),$chr(58)) !isnum) { %action ( $+ $wmm_bold($nick) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) !isin $2) && ($remove($2,$chr(46)) !isnum) { %action ( $+ $wmm_bold($nick) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) isin $2) && ($gettok($2,2,58) !isnum) { %action ( $+ $wmm_bold($nick) $+ ): $lang(44) - $lang(49) | return }
    if ($chr(58) isin $2) && (!$longip($gettok($2,1,58))) { %action ( $+ $wmm_bold($nick) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) !isin $2) && (!$longip($2)) { %action ( $+ $wmm_bold($nick) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) isin $2) && ($gettok($2,1,58) == 127.0.0.1) { %action ( $+ $wmm_bold($nick) $+ ): $lang(44) - $lang(45) | return }
    if ($chr(58) !isin $2) && ($2 == 127.0.0.1) { %action ( $+ $wmm_bold($nick) $+ ): $lang(44) - $lang(45) | return }
    var %s = $mod $+ _portchecker_ $+ $wmm_random
    sockopen %s $replace($2-,$chr(58),$chr(32))
    sockmark %s $nick $chan %action $replace($2-,$chr(58),$chr(32))
  }
...
ON *:SOCKOPEN:wpc_portchecker_*: {
  tokenize 32 $sock($sockname).mark
  if (msg isin $3) { var %output = $3 $2 }
  elseif (notice isin $3) { var %output = $3 $1 }

  if ($sockerr > 0) { %output ( $+ $wmm_bold($1) $+ ): $lang(46) $qt($wmm_bold($sock($sockname).port)) $lang(50) $wmm_under($lang(41)) $lang(43) $qt($wmm_bold($sock($sockname).ip)) $lang(42) $+ . | return }

  %output ( $+ $wmm_bold($1) $+ ): $lang(46) $qt($wmm_bold($sock($sockname).port)) $lang(50) $wmm_under($lang(40)) $lang(43) $qt($wmm_bold($sock($sockname).ip)) $lang(42) $+ .
  sockclose $sockname
  return
  :error | wmm_werror $addon $scriptline $error | reseterror
}
...
alias wpc_ver { return $right($gettok($read($script,n,6),3,32),3) }
alias wpc_crdate { return $remove($gettok($read($script,n,6),5,32),$chr(40),$chr(41)) }

alias -l mod { return wpc }
alias -l command { return port }
...
#wpc_menu_status end
#wpc_menu_channel off
menu channel { 
  -
  $iif($isalias(wmm_isadi) && $wmm_isadi && $file($scriptdir $+ $mod $+ _main.ico),$menuicon($scriptdir $+ $mod $+ _main.ico)) $iif($dialog( [ $+ [ $mod ] $+ ] _sets),$style(1)) $iif($isalias(wmm_qd),$wmm_qd($addon v $+ $ [ $+ [ $mod ] $+ ] _ver - $iif($lang(4),$v1,Settings) $+ ),* $addon v $+ $ [ $+ [ $mod ] $+ ] _ver - Settings *): $+ $mod $+ _sets
  -
}
#wpc_menu_channel end
#wpc_menu_nicklist off
menu nicklist { 
  -
  $iif($isalias(wmm_isadi) && $wmm_isadi && $file($scriptdir $+ $mod $+ _main.ico),$menuicon($scriptdir $+ $mod $+ _main.ico)) $iif($dialog( [ $+ [ $mod ] $+ ] _sets),$style(1)) $iif($isalias(wmm_qd),$wmm_qd($addon v $+ $ [ $+ [ $mod ] $+ ] _ver - $iif($lang(4),$v1,Settings) $+ ),* $addon v $+ $ [ $+ [ $mod ] $+ ] _ver - Settings *): $+ $mod $+ _sets
  -
}
#wpc_menu_nicklist end
#wpc_menu_query off
menu query { 
  -
  $iif($isalias(wmm_isadi) && $wmm_isadi && $file($scriptdir $+ $mod $+ _main.ico),$menuicon($scriptdir $+ $mod $+ _main.ico)) $iif($dialog( [ $+ [ $mod ] $+ ] _sets),$style(1)) $iif($isalias(wmm_qd),$wmm_qd($addon v $+ $ [ $+ [ $mod ] $+ ] _ver - $iif($lang(4),$v1,Settings) $+ ),* $addon v $+ $ [ $+ [ $mod ] $+ ] _ver - Settings *): $+ $mod $+ _sets
